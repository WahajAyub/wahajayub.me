...
2. A standalone cloud Codex scheduled task uses ChatGPT/Codex subscription
   usage to
   ...
   through the connected GitHub app. This avoids the OpenAI API and does not
   require a local computer to remain online.
